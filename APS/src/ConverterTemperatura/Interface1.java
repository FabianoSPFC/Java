...
public class Interface1 extends javax.swing.JFrame implements ChangeListener {
    ...
    private void initComponents() {
        ...
        temp_Kel.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                temp_KelMouseMoved(evt);
            }
        });
        ...
        temp_Far.addMouseMotionListener(new java.awt.event.MouseMotionAdapter() {
            public void mouseMoved(java.awt.event.MouseEvent evt) {
                temp_FarMouseMoved(evt);
            }
        });
    ...
    private void converterActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_converterActionPerformed
        ...
        if (bot_Cel.isSelected() && var.equals("Farenheit")) {
            ...
            temp_Cel.setValue((int) c);
            temp_Far.setValue((int) f);
        }
    ...
    private void temp_FarMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_temp_FarMouseMoved
        DecimalFormat df = new DecimalFormat("###,##0.00");
    ...
    }//GEN-LAST:event_temp_FarMouseMoved

    private void temp_KelMouseMoved(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_temp_KelMouseMoved
        DecimalFormat df = new DecimalFormat("###,##0.00");
    ...
    }//GEN-LAST:event_temp_KelMouseMoved
